...
cactus_img = pygame.image.load('wall.png')
...
pygame.display.set_caption('Lukas Bitcoins Vs. Kebri The Goat')
...
class Dragon:
    ...
    def __init__(self):
        self.dragon_img = pygame.image.load('kebri3.png')
...
class Flames:
    ...
    def __init__(self):
        self.flames = pygame.image.load('fireb2.png')
...
class Mario:
    ...
    def __init__(self):
        self.mario_img = pygame.image.load('output-onlinepngtools.png')
...
def game_over():
    ...
    music = pygame.mixer.Sound('priori.wav')
    music.play()
    topscore.top_score(SCORE)
    game_over_img = pygame.image.load('OP.png')
...
def start_game():
    canvas.fill(BLACK)
    start_img = pygame.image.load('OP.png')
...
def game_loop():
    while True:
        ...
        global  HIGH_SCORE
        flames_list = []
        pygame.mixer.music.load('dtom.wav')
